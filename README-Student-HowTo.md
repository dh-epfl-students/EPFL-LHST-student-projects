...
2. Connect a second time to the remote server through SSH, setting up a SSH tunnel. Run the following command from your local machine: `ssh -L XXXX:localhost:XXXX [gasparname]@iccluster0NN.iccluster.epfl.ch`
